...
|-----------|-----------|-----------|
| Indirect | billing controldb nonroot sqlinstance | kube-rbac (Recommend to test against different K8s distros) <br> ci-billing telemetry-grafana telemetry-kafka telemetry-monitorstack ci-sqlinstance sqlinstance-credentialrotation sqlinstance-ha sqlinstance-tde postgres |
| Direct | direct-crud direct-hydration controldb nonroot sqlinstance | kube-rbac (Recommend to test against different K8s distros) <br> ci-billing telemetry-grafana telemetry-kafka telemetry-monitorstack ci-sqlinstance sqlinstance-credentialrotation sqlinstance-ha sqlinstance-tde postgres |
