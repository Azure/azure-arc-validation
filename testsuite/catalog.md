...
## Arc Data Services with Indirect mode

This test plugin automates the provisioning and testing of Azure Arc enabled data services "Data controller , SQL MI and PostgreSQL" on a Kubernetes cluster.
...
## Arc Data Services with Direct mode
...
This test plugin will determine if the Kubernetes cluster is Azure Arc data services with direct mode conformant. Following tests are a part of this test suite:
